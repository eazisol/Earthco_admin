        ...
        <div className="collapse navbar-collapse justify-content-between">
          ...
          <ul className="navbar-nav header-right">
            ...
            <li className="nav-item align-items-center header-border">
              <a href="/logout" className="btn btn-primary btn-sm">Logout</a>
            </li>
                ...
                <a className="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <div className="header-info2 d-flex align-items-center">
                    <div className="header-media">
                      <img src="/src/assets/img/team/team-1.jpg" alt="User" />
                    </div>
                  ...
                  <div className="card border-0 mb-0">
                    <div className="card-header py-2">
                      <div className="products">
                        <img src="/src/assets/img/team/team-1.jpg" className="avatar avatar-md" alt="User" />
                        <div>
                          <h6>Thomas Fleming</h6>
                    ...
                    <div className="card-body px-0 py-2">
                      ...
                      <a href="/projects" className="dropdown-item ai-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-pie-chart">
                      ...
                      <a href="/messages" className="dropdown-item ai-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="/notifications" className="dropdown-item ai-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="card-footer px-0 py-2">
                      <a href="/settings" className="dropdown-item ai-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="/logout" className="dropdown-item ai-icon">
