...
import tab1 from '../../assets/img/5.jpg'

const drawerWidth = 220;
const PRIMARY_GREEN = "#000000e6";
...
export default function DashboardLayout({ children, onLogout }) {
  ...
  const handleDrawerToggle = () => {
    ...
    if (deznav) {
      deznav.classList.toggle('menu-toggle');
    }
  };
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", background: "#f4f6f8" }}>
      <CssBaseline />
      <div id="main-wrapper-dashboard" className={`show w-100 ${menuOpen ? 'menu-toggle' : ''}`}>
        <div className="nav-header">
         <img src={logo} alt="logo" width={150} />
          <div className="nav-control">
            <div className={`hamburger ${!open ? 'is-active' : ''}`} onClick={handleDrawerToggle}>
                ...
                <ul className="navbar-nav header-right">
							<li className="nav-item dropdown notification_dropdown">
								...
								<div className="dropdown-menu dropdown-menu-end">
									<div id="DZ_W_TimeLine02" className="widget-timeline dz-scroll  p-3 height370">
							...
							<li className="nav-item dropdown notification_dropdown">
								...
								<path d="M16.9026 6.85114L12.4593 10.4642C11.6198 11.1302 10.4387 11.1302 9.59922 10.4642L5.11844 6.85114" stroke="white" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
								<path fillRule="evenodd" clipRule="evenodd" d="M15.9089 19C18.9502 19.0084 21 16.5095 21 13.4384V6.57001C21 3.49883 18.9502 1 15.9089 1H6.09114C3.04979 1 1 3.49883 1 6.57001V13.4384C1 16.5095 3.04979 19.0084 6.09114 19H15.9089Z" stroke="white" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
								</svg>
							...
							<li className="nav-item ps-3">
								<div className="dropdown header-profile2">
									<a className="nav-link" href="javascript:void(0);" role="button" onClick={() => {
										const dropdown = document.querySelector('.header-profile2 .dropdown-menu');
									...
									<div className="dropdown-menu dropdown-menu-end" style={{position: 'absolute', top: '100%', right: 0, zIndex: 1000}}>
										<div className="card border-0 mb-0">
											<div className="card-body px-0 py-2">
												<a href="" className="dropdown-item ai-icon ">
													...
													<path fillRule="evenodd" clipRule="evenodd" d="M11.9848 12.0059C14.5229 12.0059 16.58 9.94779 16.58 7.40969C16.58 4.8716 14.5229 2.81445 11.9848 2.81445C9.44667 2.81445 7.38857 4.8716 7.38857 7.40969C7.38 9.93922 9.42381 11.9973 11.9524 12.0059H11.9848Z" stroke="var(--primary)" stroke-width="1.42857" strokeLinecap="round" strokeLinejoin="round"/>
													</svg>

													<span className="ms-2">Profile </span>
												</a>
												<a href="" className="dropdown-item ai-icon ">
													<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
												...
												<a href="" className="dropdown-item ai-icon ">
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.9026 8.85114L13.4593 12.4642C12.6198 13.1302 11.4387 13.1302 10.5992 12.4642L6.11844 8.85114" stroke="var(--primary)" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
													<path fillRule="evenodd" clipRule="evenodd" d="M16.9089 21C19.9502 21.0084 22 18.5095 22 15.4384V8.57001C22 5.49883 19.9502 3 16.9089 3H7.09114C4.04979 3 2 5.49883 2 8.57001V15.4384C2 18.5095 4.04979 21.0084 7.09114 21H16.9089Z" stroke="var(--primary)" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
													</svg>
												...
												<a href="" className="dropdown-item ai-icon ">
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<path d="M14.3888 20.8572C13.0247 22.372 10.8967 22.3899 9.51947 20.8572" stroke="var(--primary)" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
														</svg>
											...
											<div className="card-footer px-0 py-2">
												<a href="" className="dropdown-item ai-icon ">
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<circle cx="12.175" cy="11.889" r="2.63616" stroke="var(--primary)" stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round"/>
														</svg>

													<span className="ms-2">Settings </span>
												</a>
												<a href="" className="dropdown-item ai-icon">
													<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
        ...
        <div className={`deznav ${!open ? 'menu-toggle' : ''}`}>
          <div className="deznav-scroll">
            <ul className="metismenu" id="menu">
              {menuItems.map((item, index) => (
                <li key={index}>
                  <a href={item.path} className="ai-icon" aria-expanded={open}>
                    {item.icon}
